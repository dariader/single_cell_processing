...
# run these if data was not normalized or rank-transformed
...
```{r}
r1.clustMats <- MakeCMfA(rank.mat, r1.viperDist, clustering = r1.clusts$k6, out.dir = '/home/daria/Rprojects/LV_SC_project/', out.name = 'pbmc-r1-clusts')
```
...
```{r, fig.align = 'center', fig.width = 9, fig.height = 6}
plot=ClusterScatter(r2.cbcUMAP, predictions$pruned.labels, 'Viper Clustering (Louvain)')
plot
```
